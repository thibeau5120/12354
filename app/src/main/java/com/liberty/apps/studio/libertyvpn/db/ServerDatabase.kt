 ...
 */
internal object ServerDatabase {
    private const val TEXT_TYPE = " TEXT"
    private const val INTEGER_TYPE = " INTEGER"
    private const val COMMA_SEP = ","
    val SQL_CREATE_SERVER = "CREATE TABLE " + ServerEntry.TABLE_NAME + " (" +
            ServerEntry.ID + " INTEGER PRIMARY KEY," +
            ...
            " )"
    const val SQL_DELETE_SERVER = "DROP TABLE IF EXISTS " + ServerEntry.TABLE_NAME
}
